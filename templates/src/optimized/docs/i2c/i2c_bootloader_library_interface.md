...
The function continuously waits for application firmware from the host device via I2C and perfroms Erase/Program/Verify operations on internal flash memory
