...
<#elseif (HarmonyCore.SELECT_RTOS)?? && HarmonyCore.SELECT_RTOS == "FreeRTOS">
    ...
    <#lt>    xTaskCreate( _bootloader_Tasks,
    <#lt>        "BOOTLOADER_TASKS",
    <#lt>        ${BTL_STACK_SIZE},
    <#lt>        (void*)NULL,
...
<#elseif (HarmonyCore.SELECT_RTOS)?? && HarmonyCore.SELECT_RTOS == "MicriumOSIII">
    ...
    <#lt>    OSTaskCreate((OS_TCB      *)&_bootloader_Tasks_TCB,
    <#lt>                 (CPU_CHAR    *)"BOOTLOADER_TASKS",
    <#lt>                 (OS_TASK_PTR  )_bootloader_Tasks,
    <#lt>                 (void        *)0,
    <#lt>                 (OS_PRIO      )${BTL_RTOS_TASK_PRIORITY},
    <#lt>                 (CPU_STK     *)&_bootloader_TasksStk[0],
    <#lt>                 (CPU_STK_SIZE )0u,
...
<#elseif (HarmonyCore.SELECT_RTOS)?? && HarmonyCore.SELECT_RTOS == "MbedOS">
    <#lt>    Thread BTL_thread((osPriority)(osPriorityNormal + (${BTL_RTOS_TASK_PRIORITY} - 1)), ${BTL_RTOS_STACK_SIZE}, NULL, "_bootloader_Tasks");
    <#lt>    BTL_thread.start(callback(_bootloader_Tasks, (void *)NULL));
</#if>
